...
def show_multi(learn, rows=3, cols=3, figsize=(8, 8)):
...
Learner.show_multi = show_multi


def show_single(learn, rows=3, cols=3, figsize=(8, 8)):
...
Learner.show_single = show_single
